...
std::vector<DLSEstimator::M_t> DLSEstimator::Estimate(
    ...
    bool success = cv::solvePnP(objectPoints, imagePoints, cameraMatrix, distCoeffs, rvec, tvec, false, cv::SOLVEPNP_DLS);
...
void DLSEstimator::Residuals(const std::vector<X_t>& points2D,
